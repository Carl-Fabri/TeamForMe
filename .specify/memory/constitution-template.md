...
- Color, spacing, and typography MUST target WCAG 2.1 AA contrast; layout MUST be built
  with responsive Tailwind utilities, not fixed pixel widths that break below 360px.
...
- **Styling**: Tailwind CSS v4 via the PostCSS pipeline. Global CSS is limited to design
  tokens, resets, and base element styles; component-specific styling stays with the
  component.
